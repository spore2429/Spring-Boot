...
<script type="text/javascript">
  $(function() {
	  ...
	  $("#btnphoto").click(function() {
		  ...
		  $("#myphoto").trigger("click"); //사진선택버튼을 눌렀을때 id가 myphoto인 input에 트리거발생
	});
...
<body style="background-color: black;">
	<div style="margin: 100px 100px;">
		<form action="insert" method="post" enctype="multipart/form-data" onsubmit="return check()"> <!-- onsumit시 함수check로이동 -->
			<table class="table table-bordered" style="width: 600px;">
				<caption align="top"><b style="color: white;">회원가입</b></caption>
				<tr>
				...
				<tr>
				  <td>
				    ...
				    <span class="passsucess" style="width: 60px; color: green;"></span></div>
				  </td>
				</tr>
				<tr>
				  <td>
